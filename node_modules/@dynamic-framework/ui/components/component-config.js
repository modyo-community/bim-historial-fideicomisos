...
const PREFIX_BS = 'bs-';
const ICON_FAMILY_CLASS = 'bi';
const ICON_FAMILY_PREFIX = 'bi-';

export { ICON_FAMILY_CLASS as I, PREFIX_BS as P, ICON_FAMILY_PREFIX as a, state as b, currency_min as c, setIconSettings as s };
